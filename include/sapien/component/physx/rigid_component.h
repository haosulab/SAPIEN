...
CEREAL_REGISTER_TYPE(sapien::component::PhysxRigidDynamicComponent);
CEREAL_REGISTER_TYPE(sapien::component::PhysxRigidStaticComponent);

CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxBaseComponent,
                                     sapien::component::PhysxRigidBaseComponent);
CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxRigidBaseComponent,
                                     sapien::component::PhysxRigidBodyComponent);
CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxRigidBaseComponent,
                                     sapien::component::PhysxRigidStaticComponent);
CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxRigidBodyComponent,
                                     sapien::component::PhysxRigidDynamicComponent);
