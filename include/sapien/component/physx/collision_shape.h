...
CEREAL_REGISTER_TYPE(sapien::component::PhysxCollisionShapePlane);
...
CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxCollisionShape,
                                     sapien::component::PhysxCollisionShapePlane);
CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxCollisionShape,
                                     sapien::component::PhysxCollisionShapeBox);
CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxCollisionShape,
...
CEREAL_REGISTER_POLYMORPHIC_RELATION(sapien::component::PhysxCollisionShape,
                                     sapien::component::PhysxCollisionShapeTriangleMesh);
