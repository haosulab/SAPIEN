...
extern "C" __device__ unsigned __nv_isGlobal_impl(const void *);
extern "C" __device__ unsigned __nv_isShared_impl(const void *);
extern "C" __device__ unsigned __nv_isConstant_impl(const void *);
extern "C" __device__ unsigned __nv_isLocal_impl(const void *);
