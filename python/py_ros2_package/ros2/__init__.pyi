...
class RobotManager():
    ...
    def build_cartesian_velocity_controller(self, group_name: str, service_name: str = '', latency: float = 0) -> CartesianVelocityController: ...
    def build_joint_velocity_controller(self, joint_names: List[str], service_name: str = '', latency: float = 0) -> JointVelocityController: ...
    def build_motion_planner(self, group_name: str, service_name: str = '') -> MotionPlanner: ...
    ...
    def set_kinematics_config(self, config: KinematicsConfig = <KinematicsConfig object at 0x7f57669339d0>) -> bool: ...
    def set_motion_planning_config(self, config: MotionPlanningConfig = <MotionPlanningConfig object at 0x7f5766933a08>) -> bool: ...
    pass
class SceneManager():
