...
class ActorBuilder():
    def add_box_shape(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), size: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None: 
        """
        add_box_shape(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), size: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: sapien.core.pysapien_ros2.core.PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None
        """
    def add_box_visual(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), size: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), color: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None: 
        """
        add_box_visual(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), size: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), color: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None
        """
    def add_box_visual_complex(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), size: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: PxrMaterial = PxrMaterial(), name: str = '') -> None: 
        """
        add_box_visual_complex(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), size: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: sapien.core.pysapien_ros2.core.PxrMaterial = PxrMaterial(), name: str = '') -> None
        """
    def add_capsule_shape(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, half_length: float = 1, material: PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None: 
        """
        add_capsule_shape(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, half_length: float = 1, material: sapien.core.pysapien_ros2.core.PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None
        """
    def add_capsule_visual(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, half_length: float = 1, color: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None: 
        """
        add_capsule_visual(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, half_length: float = 1, color: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None
        """
    def add_capsule_visual_complex(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, half_length: float = 1, material: PxrMaterial = PxrMaterial(), name: str = '') -> None: 
        """
        add_capsule_visual_complex(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, half_length: float = 1, material: sapien.core.pysapien_ros2.core.PxrMaterial = PxrMaterial(), name: str = '') -> None
        """
    ...
    def add_convex_shape_from_file(self, filename: str, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), scale: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None: 
        """
        add_convex_shape_from_file(self: sapien.core.pysapien_ros2.core.ActorBuilder, filename: str, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), scale: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: sapien.core.pysapien_ros2.core.PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None
        """
    def add_multiple_convex_shapes_from_file(self, filename: str, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), scale: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None: 
        """
        add_multiple_convex_shapes_from_file(self: sapien.core.pysapien_ros2.core.ActorBuilder, filename: str, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), scale: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), material: sapien.core.pysapien_ros2.core.PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None
        """
    def add_sphere_shape(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, material: PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None: 
        """
        add_sphere_shape(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, material: sapien.core.pysapien_ros2.core.PxMaterial = None, density: float = 1000, patch_radius: float = 0.0, min_patch_radius: float = 0.0) -> None
        """
    def add_sphere_visual(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, color: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None: 
        """
        add_sphere_visual(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, color: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None
        """
    def add_sphere_visual_complex(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, material: PxrMaterial = PxrMaterial(), name: str = '') -> None: 
        """
        add_sphere_visual_complex(self: sapien.core.pysapien_ros2.core.ActorBuilder, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), radius: float = 1, material: sapien.core.pysapien_ros2.core.PxrMaterial = PxrMaterial(), name: str = '') -> None
        """
    def add_visual_from_file(self, filename: str, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), scale: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None: 
        """
        add_visual_from_file(self: sapien.core.pysapien_ros2.core.ActorBuilder, filename: str, pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), scale: numpy.ndarray[float32] = array([1., 1., 1.], dtype=float32), name: str = '') -> None
        """
...
class ActorType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    DYNAMIC: sapien.core.pysapien_ros2.core.ActorType # value = ActorType.DYNAMIC
    KINEMATIC: sapien.core.pysapien_ros2.core.ActorType # value = ActorType.KINEMATIC
    KINEMATIC_LINK: sapien.core.pysapien_ros2.core.ActorType # value = ActorType.KINEMATIC_LINK
    LINK: sapien.core.pysapien_ros2.core.ActorType # value = ActorType.LINK
    STATIC: sapien.core.pysapien_ros2.core.ActorType # value = ActorType.STATIC
...
class ArticulationJointType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    FIX: sapien.core.pysapien_ros2.core.ArticulationJointType # value = ArticulationJointType.FIX
    PRISMATIC: sapien.core.pysapien_ros2.core.ArticulationJointType # value = ArticulationJointType.PRISMATIC
    REVOLUTE: sapien.core.pysapien_ros2.core.ArticulationJointType # value = ArticulationJointType.REVOLUTE
    SPHERICAL: sapien.core.pysapien_ros2.core.ArticulationJointType # value = ArticulationJointType.SPHERICAL
    UNDEFINED: sapien.core.pysapien_ros2.core.ArticulationJointType # value = ArticulationJointType.UNDEFINED
...
class ArticulationType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    DYNAMIC: sapien.core.pysapien_ros2.core.ArticulationType # value = ArticulationType.DYNAMIC
    KINEMATIC: sapien.core.pysapien_ros2.core.ArticulationType # value = ArticulationType.KINEMATIC
...
class Engine():
    ...
    def create_scene(self, config: SceneConfig = <SceneConfig object at 0x7f41729afd50>) -> Scene: ...
...
class LinkBuilder(ActorBuilder):
    ...
    def set_joint_properties(self, joint_type: ArticulationJointType, limits: numpy.ndarray[float32], parent_pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), child_pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), friction: float = 0, damping: float = 0) -> None: 
        """
        set_joint_properties(self: sapien.core.pysapien_ros2.core.LinkBuilder, joint_type: sapien.core.pysapien_ros2.core.ArticulationJointType, limits: numpy.ndarray[float32], parent_pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), child_pose: sapien.core.pysapien_ros2.core.Pose = Pose([0, 0, 0], [1, 0, 0, 0]), friction: float = 0, damping: float = 0) -> None
        """
    def set_mass_and_inertia(self, arg0: float, arg1: Pose, arg2: numpy.ndarray[float32]) -> None: ...
...
class OptifuserRenderer(IPxrRenderer):
    def __init__(self, glsl_dir: str = '', glsl_version: str = '', config: OptifuserConfig = <OptifuserConfig object at 0x7f41ba2779d0>) -> None: ...
...
class PinocchioModel():
    def compute_coriolis_matrix(self, qpos: numpy.ndarray[float64, _Shape[m, 1]], qvel: numpy.ndarray[float64, _Shape[m, 1]]) -> numpy.ndarray[float64, _Shape[m, n]]: ...
    def compute_forward_dynamics(self, qpos: numpy.ndarray[float64, _Shape[m, 1]], qvel: numpy.ndarray[float64, _Shape[m, 1]], qf: numpy.ndarray[float64, _Shape[m, 1]]) -> numpy.ndarray[float64, _Shape[m, 1]]: ...
    def compute_forward_kinematics(self, qpos: numpy.ndarray[float64, _Shape[m, 1]]) -> None: ...
    def compute_full_jacobian(self, qpos: numpy.ndarray[float64, _Shape[m, 1]]) -> None: ...
    def compute_generalized_mass_matrix(self, qpos: numpy.ndarray[float64, _Shape[m, 1]]) -> numpy.ndarray[float64, _Shape[m, n]]: ...
    def compute_inverse_dynamics(self, qpos: numpy.ndarray[float64, _Shape[m, 1]], qvel: numpy.ndarray[float64, _Shape[m, 1]], qacc: numpy.ndarray[float64, _Shape[m, 1]]) -> numpy.ndarray[float64, _Shape[m, 1]]: ...
    def compute_inverse_kinematics(self, link_index: int, pose: Pose, eps: float = 0.0001, max_iterations: int = 1000, dt: float = 0.1, damp: float = 1e-06) -> Tuple[numpy.ndarray[float64, _Shape[m, 1]], bool, numpy.ndarray[float64, _Shape[6, 1]]]: ...
    def compute_single_link_local_jacobian(self, qpos: numpy.ndarray[float64, _Shape[m, 1]], link_index: int) -> numpy.ndarray[float64, _Shape[6, n]]: ...
    def get_link_jacobian(self, link_index: int, local: bool = False) -> numpy.ndarray[float64, _Shape[6, n]]: ...
...
class Pose():
    def __init__(self, p: numpy.ndarray[float32] = array([0., 0., 0.], dtype=float32), q: numpy.ndarray[float32] = array([1., 0., 0., 0.], dtype=float32)) -> None: 
        """
        __init__(self: sapien.core.pysapien_ros2.core.Pose, p: numpy.ndarray[float32] = array([0., 0., 0.], dtype=float32), q: numpy.ndarray[float32] = array([1., 0., 0., 0.], dtype=float32)) -> None
        """
...
class Scene():
    ...
    def add_ground(self, altitude: float, render: bool = True, material: PxMaterial = None, render_material: PxrMaterial = PxrMaterial()) -> None: 
        """
        add_ground(self: sapien.core.pysapien_ros2.core.Scene, altitude: float, render: bool = True, material: sapien.core.pysapien_ros2.core.PxMaterial = None, render_material: sapien.core.pysapien_ros2.core.PxrMaterial = PxrMaterial()) -> None
        """
    ...
    def name(self) -> str:
        ...
        """
    @property
    def render_id_to_visual_name(self) -> Dict[int, str]:
        """
        :type: Dict[int, str]
        """
    @property
...
class SolverType():
    ...
    def name(self) -> None:
        ...
        :type: None
        """
    PGS: sapien.core.pysapien_ros2.core.SolverType # value = SolverType.PGS
    TGS: sapien.core.pysapien_ros2.core.SolverType # value = SolverType.TGS
...
class VulkanCamera(ICamera, ISensor):
    ...
    def get_obj_segmentation(self) -> numpy.ndarray[int32]: ...
    def get_pose(self) -> Pose: ...
    def get_position_rgba(self) -> numpy.ndarray[float32]: ...
    def get_projection_matrix(self) -> numpy.ndarray[float32]: ...
    def get_segmentation(self) -> numpy.ndarray[int32]: ...
    def get_width(self) -> int: ...
    def set_initial_pose(self, pose: Pose) -> None: ...
