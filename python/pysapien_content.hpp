...
public:
  ...
  void enter() { StartProfilerBlock(mName.c_str()); }
...
be locked, limited, or free.)doc")
  ...
  PyArticulationBase
      ...
      .def("_export_kinematics_chain_urdf_string", &SArticulationBase::exportKinematicsChainAsURDF,
           py::arg("fix_root_link") = true)
      ...
      .def(
          ...
          [](LinkBuilder &b, std::string const &jointType, py::array_t<PxReal> const &limits,
            ...
            if (jointType == "revolute" || jointType == "hinge") {
              ...
              throw std::runtime_error(
                  "Unsupported joint type: " + jointType +
...
Args:
  ...
  //            "Given link index, get link pose (in articulation base frame) from forward
  //            kinematics. " "Must be called after compute_forward_kinematics.",
  //            py::arg("link_index"))
  ...
  //     active_qmask: dof sized integer array, 1 to indicate active joints and 0 for inactive
  //     joints, default to all 1s max_iterations: number of iterations steps dt: iteration step
  //     "speed" damp: iteration step "damping"
  // Returns:
  //     result: qpos from IK
  //     success: whether IK is successful
  //     error: se3 norm error
  // )doc",
  //            py::arg("link_index"), py::arg("pose"), py::arg("initial_qpos") =
  //            Eigen::VectorXd{}, py::arg("active_qmask") = Eigen::VectorXi{}, py::arg("eps") =
  //            1e-4, py::arg("max_iterations") = 1000, py::arg("dt") = 0.1, py::arg("damp") =
  //            1e-6)
  //       .def("compute_forward_dynamics", &PinocchioModel::computeForwardDynamics,
  //       py::arg("qpos"),
  //            py::arg("qvel"), py::arg("qf"))
  //       .def("compute_inverse_dynamics", &PinocchioModel::computeInverseDynamics,
  //       py::arg("qpos"),
  ...
  //       &PinocchioModel::computeSingleLinkLocalJacobian,
