...
py::array_t<float> make_array(float a, float b, float c) {
  float data[3] = {a, b, c};
  return py::array_t<float>(3, data);
}

py::array_t<float> make_array(float a, float b, float c, float d) {
  float data[4] = {a, b, c, d};
  return py::array_t<float>(4, data);
}
...
PYBIND11_MODULE(sapyen, m) {
  ...
  py::class_<Optifuser::CameraSpec>(m, "CameraSpec")
      ...
      .def_property_readonly(
          ...
          [](Optifuser::CameraSpec &c) {
            return make_array(c.rotation.w, c.rotation.x, c.rotation.y, c.rotation.z);
          })
  ...
  py::class_<Optifuser::FPSCameraSpec, Optifuser::CameraSpec>(m, "FPSCameraSpec")
      ...
      .def("getRotation0", [](Optifuser::FPSCameraSpec &c) {
        ...
        return make_array(q.w, q.x, q.y, q.z);
      });
  ...
  py::class_<PxTransform>(m, "PxTransform")
      .def(py::init([](py::array_t<float> p, py::array_t<float> q) {
           ...
           py::return_value_policy::automatic, py::arg("p") = make_array(0, 0, 0),
           py::arg("q") = make_array(1, 0, 0, 0))
      .def_property_readonly(
          "p", [](PxTransform &t) { return py::array_t<PxReal>(3, (PxReal *)(&t.p)); })
      .def_property_readonly("q",
                             [](PxTransform &t) {
                               return make_array(t.q.w, t.q.x, t.q.y, t.q.z);
                             })
      .def("set_p",
  ...
  py::class_<ArticulationBuilder>(m, "ArticulationBuilder")
      ...
      .def("addBoxShapeToLink",
           ...
           py::arg("scale") = make_array(1, 1, 1), py::arg("material") = nullptr)
      ...
      .def("addBoxVisualToLink",
           ...
           py::arg("link"), py::arg("pose") = PxTransform{{0, 0, 0}, PxIdentity},
           py::arg("scale") = make_array(1, 1, 1), py::arg("color") = make_array(1, 1, 1))
      .def("addCapsuleVisualToLink", 
           ...
           py::arg("length") = 1, py::arg("color") = make_array(1, 1, 1))
