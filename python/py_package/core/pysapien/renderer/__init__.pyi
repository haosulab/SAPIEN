...
class UIKeyFrameEditor(UIWidget):
    ...
    def DragKeyFrameCallback(self, func: typing.Callable[[UIKeyFrameEditor], None]) -> UIKeyFrameEditor: ...
    ...
    def get_dragged_index(self) -> int: ...
    def get_dragged_new_val(self) -> int: ...
    pass
