...
class UIKeyFrameEditor(UIWidget):
    ...
    def add_duration(self, id: int, keyframe1_id: int, keyframe2_id: int, name: str, definition: str) -> None: ...
    def add_key_frame(self, id: int, frame: int) -> None: ...
    def append(self, *args) -> UIKeyFrameEditor: ...
    def clear(self) -> None: ...
    def get_current_frame(self) -> int: ...
    def get_duration_id_generator(self) -> UIIdGenerator: ...
    def get_duration_id_generator_state(self) -> int: ...
    def get_durations_in_used(self) -> typing.List[UIDuration]: ...
    def get_key_frame_id_generator(self) -> UIIdGenerator: ...
    def get_key_frame_id_generator_state(self) -> int: ...
    def get_key_frame_to_modify(self) -> int: ...
    def get_key_frames_in_used(self) -> typing.List[UIKeyFrame]: ...
    def get_total_frame(self) -> int: ...
    def set_duration_id_generator_state(self, state: int) -> None: ...
    def set_key_frame_id_generator_state(self, state: int) -> None: ...
    def set_total_frame(self, count: int) -> None: ...
    pass
