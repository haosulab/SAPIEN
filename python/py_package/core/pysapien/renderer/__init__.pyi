...
class Context():
    ...
    def create_cubemap_from_files(self, arg0: typing.List[str[6]], arg1: int) -> Cubemap: ...
...
class UIInputFloat(UIWidget):
    def Callback(self, func: typing.Callable[[UIInputFloat], None]) -> UIInputText: ...
...
class UIInputFloat2(UIWidget):
    def Callback(self, func: typing.Callable[[UIInputFloat2], None]) -> UIInputText: ...
...
class UIInputFloat3(UIWidget):
    def Callback(self, func: typing.Callable[[UIInputFloat3], None]) -> UIInputText: ...
...
class UIInputFloat4(UIWidget):
    def Callback(self, func: typing.Callable[[UIInputFloat4], None]) -> UIInputText: ...
