...
class VulkanCamera(ICamera, ISensor):
    ...
    def get_model_matrix(self) -> numpy.ndarray[numpy.float32]: ...
    def get_projection_matrix(self) -> numpy.ndarray[numpy.float32]: ...
    def get_uint32_texture(self, texture_name: str) -> numpy.ndarray[uint32]: ...
...
class VulkanRenderer(IPxrRenderer):
    ...
    def create_window(self, shader_dir: str = '') -> VulkanWindow: ...
...
class VulkanWindow():
    ...
    def download_uint32_target(self, name: str) -> numpy.ndarray[uint32]: ...
    def download_uint32_target_pixel(self, name: str, x: int, y: int) -> numpy.ndarray[uint32]: ...
    def download_uint8_target(self, name: str) -> numpy.ndarray[uint8]: ...
    def download_uint8_target_pixel(self, name: str, x: int, y: int) -> numpy.ndarray[uint8]: ...
    def hide(self) -> None: ...
