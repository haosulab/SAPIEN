...
class ActorBuilder():
    ...
    def add_box_visual_complex(self, pose: Pose = Pose([0, 0, 0], [1, 0, 0, 0]), half_size: numpy.ndarray[numpy.float32] = array([1., 1., 1.], dtype=float32), material: PxrMaterial = PxrMaterial(), name: str = '') -> None: ...
...
class Scene():
    ...
    def add_ground(self, altitude: float, render: bool = True, material: PhysicalMaterial = None, render_material: PxrMaterial = PxrMaterial()) -> ActorStatic: ...
