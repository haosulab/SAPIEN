...
class Scene():
    ...
    def add_ground(self, altitude: float, render: bool = True, material: PxMaterial = None, render_material: PxrMaterial = PxrMaterial()) -> ActorStatic: 
        """
        add_ground(self: sapien.core.pysapien.Scene, altitude: float, render: bool = True, material: sapien.core.pysapien.PxMaterial = None, render_material: sapien.core.pysapien.PxrMaterial = PxrMaterial()) -> sapien.core.pysapien.ActorStatic
        """
