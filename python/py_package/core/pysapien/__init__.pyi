...
class Scene():
    ...
    pass
class SceneConfig():
    def __getstate__(self) -> typing.Tuple[numpy.ndarray[numpy.float32, _Shape[3, 1]], float, float, float, float, float, float, int, int, bool, bool, bool, bool, bool, bool]: ...
    def __init__(self) -> None: ...
    def __repr__(self) -> str: ...
    def __setstate__(self, arg0: typing.Tuple[numpy.ndarray[numpy.float32, _Shape[3, 1]], float, float, float, float, float, float, int, int, bool, bool, bool, bool, bool, bool]) -> None: ...
    @property
