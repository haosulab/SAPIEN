...
class ActorBase(Entity):
    ...
    def is_rendering_collision(self) -> bool: ...
...
class ActorBuilder():
    ...
    @property
    def c_mass_pose(self) -> Pose:
        """
        :type: Pose
        """
    @property
    def collision_groups(self) -> typing.List[int]:
        """
...
class Actor(ActorDynamicBase, ActorBase, Entity):
    def dof_are_locked(self) -> typing.List[bool]: ...
...
class Articulation(ArticulationDrivable, ArticulationBase, Entity):
    ...
    def pack(self) -> typing.List[float]: ...
    def pack_drive(self) -> typing.List[float]: ...
    ...
    def unpack(self, arg0: numpy.ndarray[numpy.float32]) -> None: ...
    def unpack_drive(self, arg0: numpy.ndarray[numpy.float32]) -> None: ...
    @property
    def fixed(self) -> bool:
        """
        :type: bool
...
class CollisionShape():
    @staticmethod
    def get_collision_groups(*args, **kwargs) -> typing.Any: ...
...
class ConvexMeshGeometry(CollisionGeometry):
    ...
    def vertices(self) -> numpy.ndarray[numpy.float32]:
        ...
        """
    pass
class DeformableEntity(Entity):
    @property
    def visual_body(self) -> RenderBody:
        """
        :type: RenderBody
        """
    pass
...
class Drive(Constraint):
    ...
    def get_actor1(self) -> ActorBase: ...
    def get_actor2(self) -> ActorBase: ...
    def get_distance_limit(self) -> float: ...
    def get_dof_states(self) -> typing.List[str]: 
        """
        Return the states of the six degrees of freedom (tx, ty, tz, rx, ry, rz) of the drive. State can
        be locked, limited, or free.
        """
    def get_pose1(self) -> Pose: ...
    def get_pose2(self) -> Pose: ...
    def get_slerp_properties(self) -> dict: ...
    def get_target(self) -> Pose: ...
    def get_target_velocity(self) -> typing.List[numpy.ndarray[numpy.float32]]: ...
    def get_x_limit(self) -> typing.List[float]: ...
    def get_x_properties(self) -> dict: ...
    def get_x_twist_limit(self) -> typing.List[float]: ...
    def get_x_twist_properties(self) -> dict: ...
    def get_y_limit(self) -> typing.List[float]: ...
    def get_y_properties(self) -> dict: ...
    def get_yz_cone_limit(self) -> typing.List[float]: ...
    def get_yz_pyramid_limit(self) -> typing.List[float]: ...
    def get_yz_swing_properties(self) -> dict: ...
    def get_z_limit(self) -> typing.List[float]: ...
    def get_z_properties(self) -> dict: ...
...
class JointRecord():
    ...
    def pose_in_parent(self) -> Pose:
        ...
        """
    pass
class KinematicArticulation(ArticulationBase, Entity):
    pass
...
class RenderBody():
    ...
    def set_custom_property(self, name: str, value: typing.Annotated[typing.List[float], FixedSize(3)]) -> None: ...
    def set_custom_texture(self, name: str, texture: RenderTexture) -> None: ...
    def set_custom_texture_array(self, name: str, textures: typing.List[RenderTexture]) -> None: ...
    def set_name(self, name: str) -> None: ...
    def set_pose(self, pose: Pose) -> None: ...
...
class RenderMaterial():
    ...
    @property
    def base_color(self) -> typing.Annotated[typing.List[float], FixedSize:
        """
        :type: typing.Annotated[typing.List[float], FixedSize
        """
    @base_color.setter
    ...
    def diffuse_texture_filename(self, arg1: str) -> None:
        pass
    @property
    def emission(self) -> typing.Annotated[typing.List[float], FixedSize:
        """
        :type: typing.Annotated[typing.List[float], FixedSize
        """
    @emission.setter
...
class Scene():
    ...
    def add_deformable_entity(self, mesh: RenderMesh, material: RenderMaterial) -> DeformableEntity: ...
    ...
    def create_gear(self, actor1: ActorBase, pose1: Pose, actor2: ActorBase, pose2: Pose) -> Gear: ...
    def create_physical_material(self, static_friction: float, dynamic_friction: float, restitution: float) -> PhysicalMaterial: ...
    ...
    def get_all_drives(self) -> typing.List[Constraint]: ...
    ...
    def remove_deformable_entity(self, entity: DeformableEntity) -> None: ...
    def remove_drive(self, drive: Constraint) -> None: ...
    def remove_gear(self, gear: Constraint) -> None: ...
...
class VulkanWindow():
    ...
    @staticmethod
    def get_target_size(*args, **kwargs) -> typing.Any: ...
    ...
    def render(self, target_name: str, ui_windows: typing.List[renderer.UIWidget] = []) -> None: ...
    def resize(self, width: int, height: int) -> None: ...
    def set_camera_parameters(self, near: float, far: float, fovy: float) -> None: ...
    def set_camera_pose(self, arg0: Pose) -> None: ...
    ...
    def set_camera_texture(self, name: str, texture: RenderTexture) -> None: ...
    def set_camera_texture_array(self, name: str, textures: typing.List[RenderTexture]) -> None: ...
    ...
    def fps(self) -> float:
        ...
        """
    @property
    def mouse_delta(self) -> typing.Annotated[typing.List[float], FixedSize:
        """
        :type: typing.Annotated[typing.List[float], FixedSize
        """
    @property
    def mouse_position(self) -> typing.Annotated[typing.List[float], FixedSize:
        """
        :type: typing.Annotated[typing.List[float], FixedSize
        """
    @property
    def mouse_wheel_delta(self) -> typing.Annotated[typing.List[float], FixedSize:
        """
        :type: typing.Annotated[typing.List[float], FixedSize
        """
    @property
    ...
    def should_close(self) -> bool:
        ...
        """
    @property
    def size(self) -> typing.Annotated[typing.List[int], FixedSize:
        """
        :type: typing.Annotated[typing.List[int], FixedSize
        """
    @property
    def super(self) -> bool:
        """
