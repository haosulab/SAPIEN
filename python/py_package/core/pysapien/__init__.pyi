...
class PinocchioModel():
    ...
    def compute_inverse_kinematics(self, link_index: int, pose: Pose, eps: float = 0.0001, max_iterations: int = 1000, dt: float = 0.1, damp: float = 1e-06) -> typing.Tuple[numpy.ndarray[numpy.float64, _Shape[m, 1]], bool, numpy.ndarray[numpy.float64, _Shape[6, 1]]]: ...
