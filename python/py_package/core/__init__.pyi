...
class Articulation(ArticulationDrivable, ArticulationBase):
    ...
    def compute_diff_ik(self, spatial_twist: numpy.ndarray[float64, _Shape[m, 1]], commanded_link_id: int, active_joint_ids: List[int] = []) -> numpy.ndarray[float32, _Shape[m, 1]]: ...
    ...
    def compute_transformation_matrix(self, source_link_ik: int, target_link_id: int) -> numpy.ndarray[float32, _Shape[4, 4]]: ...
...
class OptifuserRenderer(IPxrRenderer):
    def __init__(self, glsl_dir: str = '', glsl_version: str = '', config: OptifuserConfig = <OptifuserConfig object at 0x7f1d0daf6b90>) -> None: ...
