...
class RenderClientShapeTriangleMesh(RenderClientShape):
    def __init__(self, filename: str, scale: numpy.ndarray[typing.Any, numpy.dtype[numpy.float32]] = ...) -> None:
        ...
...
class RenderClientSystem:
    def __init__(self, address: str, process_index: int) -> None:
        ...
    def add_point_light(self, position: numpy.ndarray[typing.Any, numpy.dtype[numpy.float32]], color: numpy.ndarray[typing.Any, numpy.dtype[numpy.float32]], shadow: bool = False, shadow_near: float = 0.009999999776482582, shadow_far: float = 100.0, shadow_map_size: int = 1024) -> None:
        ...
    ...
    def set_ambient_light(self, color: numpy.ndarray[typing.Any, numpy.dtype[numpy.float32]]) -> None:
        ...
    @typing.overload
    def set_ambient_light(self, direction: numpy.ndarray[typing.Any, numpy.dtype[numpy.float32]], color: numpy.ndarray[typing.Any, numpy.dtype[numpy.float32]], shadow: bool = False, position: numpy.ndarray[typing.Any, numpy.dtype[numpy.float32]] = ..., shadow_scale: float = 5.0, shadow_near: float = 0.009999999776482582, shadow_far: float = 100.0, shadow_map_size: int = 1024) -> None:
        ...
