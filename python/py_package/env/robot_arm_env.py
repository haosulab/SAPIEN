...
class RobotArmEnv(BaseEnv):
    def __init__(self, on_screen_render: bool = True):
        ...
        for q_name in self._q_names:
            self.robot.add_force_actuator(q_name, -50, 50)
    ...
    def _load_robot(self, urdf_path: str, material: pysapien.PxMaterial) -> None:
        ...
        self.robot: pysapien.ArticulationWrapper = self.loader.load(urdf_path, material)
        ...
        links: List[pysapien.PxRigidBody] = self.robot.get_links()
