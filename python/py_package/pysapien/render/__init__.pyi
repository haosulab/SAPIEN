...
class RenderCubemap():
    ...
    def _internal_cubemap(self) -> sapien.pysapien.internal_renderer.Cubemap:
        """
        :type: sapien.pysapien.internal_renderer.Cubemap
        """
    pass
...
class RenderShapeTriangleMeshPart():
    ...
    def get_vertex_normal(self) -> numpy.ndarray[numpy.float32, _Shape[m, 3]]: ...
    def get_vertex_uv(self) -> numpy.ndarray[numpy.float32, _Shape[m, 2]]: ...
    def get_vertices(self) -> numpy.ndarray[numpy.float32, _Shape[m, 3]]: ...
    def set_vertex_normal(self, normal: numpy.ndarray[numpy.float32, _Shape[m, 3]]) -> None: ...
    def set_vertex_uv(self, uv: numpy.ndarray[numpy.float32, _Shape[m, 2]]) -> None: ...
    @property
    def cuda_triangles(self) -> CudaArrayHandle:
        """
        :type: CudaArrayHandle
