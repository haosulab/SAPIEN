...
class PhysxArticulationJoint():
    ...
    def get_type(self) -> typing.Liternal['fixed', 'revolute', 'revolute_unwrapped', 'prismatic', 'free']: ...
    ...
    def set_type(self, type: typing.Liternal['fixed', 'revolute', 'revolute_unwrapped', 'prismatic', 'free']) -> None: ...
    @property
    ...
    def stiffness(self) -> float:
        ...
        """
    @property
    def type(self) -> typing.Liternal['fixed', 'revolute', 'revolute_unwrapped', 'prismatic', 'free']:
        """
        :type: typing.Liternal['fixed', 'revolute', 'revolute_unwrapped', 'prismatic', 'free']
        """
    @type.setter
    def type(self, arg1: typing.Liternal['fixed', 'revolute', 'revolute_unwrapped', 'prismatic', 'free']) -> None:
        pass
    pass
...
class PhysxRigidBaseComponent(PhysxBaseComponent, sapien.pysapien.Component):
    def attach(self, collision_shape: PhysxCollisionShape) -> None: ...
...
class PhysxCollisionShape():
    ...
    def collision_groups(self) -> typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(4)]:
        """
        :type: typing.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(4)]
        """
    @property
...
class PhysxDistanceJointComponent(PhysxJointComponent, PhysxBaseComponent, sapien.pysapien.Component):
    def __init__(self, body: PhysxRigidBodyComponent) -> None: ...
    def get_contact_distance(self) -> float: ...
    def get_distance(self) -> float: ...
    def set_contact_distance(self, distance: float) -> None: ...
    ...
    def contact_distance(self, arg1: float) -> None:
        pass
    @property
...
class PhysxRigidDynamicComponent(PhysxRigidBodyComponent, PhysxRigidBaseComponent, PhysxBaseComponent, sapien.pysapien.Component):
    ...
    def locked_motion_axes(self) -> typing.Annotated[list[bool], pybind11_stubgen.typing_ext.FixedSize(6)]:
        """
        :type: typing.Annotated[list[bool], pybind11_stubgen.typing_ext.FixedSize(6)]
        """
    pass
