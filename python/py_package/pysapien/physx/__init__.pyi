...
class PhysxArticulation():
    ...
    def get_root_linear_velocity(self) -> numpy.ndarray[numpy.float32, _Shape, _Shape[3]]: ...
    ...
    def set_root_linear_velocity(self, velocity: numpy.ndarray[numpy.float32, _Shape, _Shape[3]]) -> None: ...
    ...
    def root_angular_velocity(self, arg1: numpy.ndarray[numpy.float32, _Shape, _Shape[3]]) -> None:
        pass
    @property
    def root_linear_velocity(self) -> numpy.ndarray[numpy.float32, _Shape, _Shape[3]]:
        """
        :type: numpy.ndarray[numpy.float32, _Shape, _Shape[3]]
        """
    @root_linear_velocity.setter
    def root_linear_velocity(self, arg1: numpy.ndarray[numpy.float32, _Shape, _Shape[3]]) -> None:
        pass
    @property
...
class PhysxGpuSystem(PhysxSystem, sapien.pysapien.System):
    def __init__(self, config: PhysxSceneConfig = SceneConfig()) -> None: ...
    def _gpu_query_articulation_link_pose_raw(self, data_buffer: CudaArrayHandle, index_buffer: CudaArrayHandle) -> None: ...
    ...
    def gpu_apply_articulation_qf(self, data_buffer: CudaArrayHandle, index_buffer: CudaArrayHandle) -> None: ...
    ...
    def gpu_create_articulation_link_pose_buffer(self) -> CudaArray: ...
    def gpu_create_articulation_link_velocity_buffer(self) -> CudaArray: ...
    ...
    def gpu_query_articulation_link_pose(self, data_buffer: CudaArrayHandle, index_buffer: CudaArrayHandle, offset_buffer: CudaArrayHandle) -> None: ...
    def gpu_query_articulation_link_velocity(self, data_buffer: CudaArrayHandle, index_buffer: CudaArrayHandle) -> None: ...
    def gpu_query_articulation_qacc(self, data_buffer: CudaArrayHandle, index_buffer: CudaArrayHandle) -> None: ...
