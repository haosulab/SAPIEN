...
class Scene():
    ...
    def get_root_position(self) -> numpy.ndarray[numpy.float32]: ...
    def get_root_rotation(self) -> numpy.ndarray[numpy.float32]: ...
    def get_root_scale(self) -> numpy.ndarray[numpy.float32]: ...
    def remove_node(self, node: Node) -> None: ...
    def set_ambient_light(self, arg0: numpy.ndarray[numpy.float32]) -> None: ...
    def set_cubemap(self, arg0: Cubemap) -> None: ...
    def set_root_transform(self, position: numpy.ndarray[numpy.float32], rotation: numpy.ndarray[numpy.float32], scale: numpy.ndarray[numpy.float32]) -> None: ...
    pass
class Shape():
    pass
class Texture():
