...
# create scene
scene.add_ground(-1)
scene.add_point_light([0, 0, 10], [2, 2, 2])

# stratic friction, dynamic driction, restitution
smooth_material = sim.create_physical_material(0.0000001, 0.00000001, 1)
...
def build_sphere(pos, r):
    ...
    sphere_builder.add_sphere_visual(Pose(pos), r, color=[255, 255, 255])
...
def build_box(pos, size):
    ...
    box_builder.add_box_visual(Pose(pos), size, color=np.random.uniform(0, 255, size=(3)))
